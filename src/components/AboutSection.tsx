        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="rounded-3xl p-8" style={{ backgroundColor: 'var(--seoul-cream)' }}>
              <div className="grid grid-cols-3 gap-8 items-center justify-items-center">
                ...
                {/* Plus Sign */}
                <div className="text-4xl" style={{ color: 'var(--seoul-rose)' }}>+</div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-block px-4 py-2 rounded-full text-sm" style={{ backgroundColor: 'var(--seoul-rose)', color: 'white' }}>
                What is Bubble Tea? 🤔
              </div>
              
              <h2 className="text-3xl md:text-4xl">
                Discover the 
                <span className="korean-handwritten block text-4xl md:text-5xl" style={{ color: 'var(--seoul-rose)' }}>
                  Korean Twist
                </span>
                on Bubble Tea
              </h2>
