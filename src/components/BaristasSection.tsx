      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -top-6 -right-6 p-6 rounded-3xl shadow-xl" style={{ backgroundColor: '#00e2f2' }}>
            ...
            <div className="absolute -bottom-4 -left-4 grid grid-cols-2 gap-2">
              <div className="w-12 h-12 rounded-full gradient-yellow-turquoise flex items-center justify-center text-xl shadow-lg">
                🏯
              </div>
              <div className="w-12 h-12 rounded-full gradient-orange-pink flex items-center justify-center text-xl shadow-lg">
                🌸
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 rounded-xl border-l-4" style={{ backgroundColor: '#fde15f', borderColor: '#00e2f2' }}>
              <p className="korean-handwritten text-xl mb-2" style={{ color: '#00e2f2' }}>
                "정성을 다해 만든 차 한 잔"
              </p>
