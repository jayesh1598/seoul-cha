...
export function Footer({ onPageChange, currentPage }: FooterProps) {
  ...
  return (
    <footer className="relative overflow-hidden" style={{ backgroundColor: "#da5f5c" }}>
      {/* Background Pattern */}
      <div className="absolute inset-0 pointer-events-none opacity-10">
        <div className="absolute top-10 left-10 text-8xl text-white">🌸</div>
        <div className="absolute top-20 right-20 text-6xl text-white">🧋</div>
        <div className="absolute bottom-20 left-20 text-7xl text-white">💜</div>
        <div className="absolute bottom-10 right-10 text-5xl text-white">✨</div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <h4 className="text-white text-lg mb-4">🏪 Seoul Cha</h4>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-white/80">Bhayli, Vadodara (Gujarat) 391410</p>
              <p className="text-white/80">☎️ (+91) 6357 013 736</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-white/80">🕒 Fri–Sat: 10AM–11PM</p>
      ...
      <div className="absolute bottom-0 left-0 w-full">
        <svg viewBox="0 0 1200 120" className="fill-white opacity-10">
